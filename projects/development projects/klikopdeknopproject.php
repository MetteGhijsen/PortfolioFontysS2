...
<div class="container">
    ...
    <div class="grid-container">
        <div class="text">
            <p> Toen wij onze allereerste development les hadden, kwam de docent met een opdracht waarbij de bedoeling
                ...
                Ik had nog geen ervaring met Javascript, dus ik wilde mezelf wel een beetje uitdagen om net iets verder te gaan.</p>
        </div>
        <div class="afbeelding">
            <img id="afbeelding1" src="../../img/development/klikopdeknop1.PNG " alt="projectimage">
        </div>
        <div class="text2">
            <p> Als eerste werd ons uitgelegd hoe we een EventListener moesten gebruiken, en hier vervolgens een functie aan moesten koppelen.
            Daarna heb ik uitgezocht hoe ik functies kon maken, en random getallen kon genereren. Aangezien dit dus mijn eerste keer Javascript was,
                heb ik al mijn research gedaan op de website van W3Schools. Ik heb een artikel gelezen,
                en vervolgens heb ik alles proberen toe te passen in mijn code. Om te kijken of er daadwerkelijk een random nummer
                gegenereerd werd, heb ik de nummers telkens in de console weergegeven. Vervolgens wilde ik aan elk nummer een coördinaat op de pagina
                koppelen door middel van if-statements. Na even gekeken te hebben bij klasgenoten, realiseerde ik me dat het handiger was om gewoon
            te werken met twee randomized X en Y waarden, die dan werden gebruikt om de knop rond te bewegen.</p>
        </div>
        <div class="text3">
            <p>De afbeelding hier langs is de uiteindelijke code van dit project. Om alles overzichtelijk en leesbaar te houden voor andere
            mensen heb ik besloten te werken met duidelijke variabele namen. Ik dacht dat de variabele MaxNummer een beetje duidelijkheid
            zou bieden voor de lezer in wat de code nou betekent. Daarna zie je dat ik twee andere variabele heb aangemaakt.
            positieX, voor de horizontale positie, en positieY voor de verticale positie. Daaronder volgt de code die achter het
                willekeurig gegenereerde nummer een % teken zet, zodat het een waarde is die gebruikt kan worden voor de margin.
        ...
        <div class="text4">
            ...
            <p>Ik denk dat ik best wel een goed idee heb gekregen van de basis van Javascript. Ik heb geleerd
                hoe ik variabelen kan aanmaken, hoe ik random nummers kan genereren, en hoe ik console.log kan gebruiken.
    ...
    <div class="download">
        ...
        <a href="/images/myw3schoolsimage.jpg" download="DrukOpDeKnop.zip">
