...
<div class="container">
    <div class="taakbalk">
        ...
        <li class="pijltje"> < </li>
        <li><a href="../../projects/interactive%20media%20projects/portfolioproject.php" class="currentpage">Portfolio
                Website</a></li>
    </div>
    ...
    <div class="grid-container">
        ...
        <div class="afbeelding">
            <img id="afbeelding1" src="../../img/placeholder.jpg " alt="projectimage">
        </div>
        <div class="text2">
            <p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
                dolore magna aliqua.
