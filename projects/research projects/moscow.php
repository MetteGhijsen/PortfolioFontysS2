...
<head>
    ...
    <link rel="stylesheet" href="../../css/moscow.css">
...
<div class="container">
    ...
    <div class="grid-container">
        <div class="image">
            <img src="../../img/research/moscowlijstje.PNG" alt="logonorecomparison">
        </div>
        <div class="text2">
            <h1> Inleiding </h1>
            <p>
            ...
            <p>
            Ik heb geleerd hoe ik onderscheid kan maken tussen de prioriteit van verschillende requirements. Ik ben echter wel van mening dat ik deze skill nog niet helemaal beheers, aangezien ik het na het maken van het volledige prototype toch anders zou hebben gedaan. Ik denk wel dat wanneer ik deze skill verder ontwikkel, deze erg nuttig kan zijn in mijn verdere carrière.
            </p>
        </div>
    </div>
</body>
